...
const ExcelProcessForm1 = ({
        ...
        return (
            <div className="container" style={{ marginBottom: "10px" }}>
                <div {...getRootProps({ style })}>
                    ...
                    <p style={{ marginTop: "40px" }}>Arrastre aquí el Excel formateado</p>
                </div>
            </div>
        );
    }
    ...
    const ProcesarExtracto = async (e) => {
        ...
        await fetch(UrlNodeServer.extractosDir.sub.process2, {
            method: 'POST',
            body: formData,
        ...
        return (
            <Card className="shadow">
                <CardHeader className="border-0">
                    ...
                    />
                    <h2 className="mb-0" style={{ textAlign: "center" }}>Importar Excel con datos bancarios</h2>
                </CardHeader>
            </Card>
        )
    } else {
