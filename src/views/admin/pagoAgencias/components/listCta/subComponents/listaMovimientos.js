...
import FilaAgencias from "../../../../../../components/subComponents/Listados/SubComponentes/FilaCta"
...
const ListaExtractos = ({
    ...
    const listar = async () => {
        ...
        setLoading(true)
        await axios.get(`${UrlNodeServer.ctaSindicalsDir.ctaSindical}/${pagina}${query}`, {
            headers:
