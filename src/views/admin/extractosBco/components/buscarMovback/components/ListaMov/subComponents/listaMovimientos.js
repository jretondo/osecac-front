...
import FilaExtractos from '../../../../../../../../components/subComponents/Listados/SubComponentes/FilaMov3'
...
const ListaExtractos = ({
    ...
    const listar = async () => {
        if (filtro) {
            ...
            setLoading(true)
            await axios.get(`${UrlNodeServer.extractosDir.sub.busquedaBack}/${pagina}${query}`, {
                headers:
