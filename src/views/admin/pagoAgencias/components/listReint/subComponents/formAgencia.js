...
const FormAgencia = ({
    ...
    const NvaAgencia = async () => {
        ...
        if (!largoCbu || !largoCuit) {
            ...
            await axios.post(UrlNodeServer.reintBenefDir.reintBenef, data, {
                headers:
    ...
    const Detalles = async () => {
        setLoanding(true)
        await axios.get(`${UrlNodeServer.reintBenefDir.sub.getOne}/${idDetalle}`, {
            headers:
                { 'Authorization': 'Bearer ' + localStorage.getItem('user-token') }
        })
            .then(res => {
            ...
            <CardBody>
                <Form onSubmit={e => {
                    ...
                    <Row>
                        <Col md="8">
                            <FormGroup>
                                <Label for="agenciaTxt">Nombre</Label>
                                <Input type="text" id="agenciaTxt" placeholder="Ingrese el nombre..." value={agencia} onChange={e => setAgencia(e.target.value)} required />
                            </FormGroup>
                        </Col>
                        <Col md="4">
                            <FormGroup>
