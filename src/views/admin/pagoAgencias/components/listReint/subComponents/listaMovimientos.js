...
import FilaAgencias from "../../../../../../components/subComponents/Listados/SubComponentes/FilaReintBenef"

const titulos = ["Nombre", "Localidad", "Email", ""]
...
const ListaExtractos = ({
    ...
    const listar = async () => {
        ...
        setLoading(true)
        await axios.get(`${UrlNodeServer.reintBenefDir.reintBenef}/${pagina}${query}`, {
            headers:
